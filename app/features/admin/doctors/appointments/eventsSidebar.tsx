...
const EventsSidebar = () => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100/80 p-4 sticky top-6">
      {/* Header */}
      <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-100">
        <div className="flex items-center gap-2">
          <CalendarDays className="w-4 h-4 text-blue-600" />
          <h3 className="font-semibold text-sm text-gray-900">Today's Events</h3>
        </div>
