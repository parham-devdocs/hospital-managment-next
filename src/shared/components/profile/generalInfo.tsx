...
<<<<<<< HEAD
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Email */}
          <div className="flex items-center gap-3 bg-black text-white rounded-xl px-4 py-3 shadow-sm min-w-0 hover:bg-gray-800 transition-colors">
            <Mail className="w-4 h-4 text-primary-400 shrink-0" />
            <span className="truncate font-medium text-sm" title={generalInfo.email}>
              {generalInfo.email}
            </span>
          </div>
          ...
          <div className="flex items-center gap-3 bg-black text-white rounded-xl px-4 py-3 shadow-sm min-w-0 hover:bg-gray-800 transition-colors">
            ...
            <span className="truncate font-medium text-sm">{generalInfo.phoneNumber}</span>
          </div>

          {/* Gender */}
          <div className="flex items-center gap-3 bg-black text-white rounded-xl px-4 py-3 shadow-sm min-w-0 hover:bg-gray-800 transition-colors">
            <User className="w-4 h-4 text-primary-400 shrink-0" />
            <span className="capitalize font-medium text-sm">{generalInfo.gender}</span>
          </div>

          {/* Age */}
          <div className="flex items-center gap-3 bg-black text-white rounded-xl px-4 py-3 shadow-sm min-w-0 hover:bg-gray-800 transition-colors">
            <Calendar className="w-4 h-4 text-primary-400 shrink-0" />
            <span className="font-medium text-sm">{generalInfo.age}</span>
          </div>
